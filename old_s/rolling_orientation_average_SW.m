...
% plot_list = {'ang_exL23_Cy,ang_inL23_Cy','ang_inL23_Sy','ang_exL23_Cx,ang_inL23_Cx',...
%     'ang_exL23_Vt,ang_inL23_Vt',...
%     'frac_vert_exL23,frac_vert_inL23','frac_vert_exL4,frac_vert_inL4','frac_vert_exL5,frac_vert_inL5'};
...
%plot_list = {'frac_vert_exL23,frac_vert_inL23','frac_vert_exL4,frac_vert_inL4',...
    ...
    %plot_list = {'ang_inL23_Cy','ang_inL23_Cx','ang_inL23_Vt'};
...
for plots = 1:plot_number
    ...
    parameter_vector = variable_selector(plot_list{plots},str,selection_vector)*69;
...
%autoArrangeFigures
%% 
al = findall(0,'type','axes');
al(1).XLim=[0 180];al(1).YLim=[0 80];al(1).XTick=[0:45:180];
al(2).XLim=[0 180];al(2).YLim=[0 80];al(2).XTick=[0:45:180];
al(3).XLim=[0 180];al(3).YLim=[0 100];al(3).XTick=[0:45:180];
