function PIPE_Trace_mapmaker_Class(file_tags)
...
for tags = 1:length(file_tags)
    ...
    load(fullfile(model_path,load_name),'trace2folder')
    load(fullfile(model_path,load_name),'soma_unique')
    load(fullfile(model_path,load_name),'uni_cells')
    load(fullfile(model_path,load_name),'interp_cell')
    load(fullfile(model_path,load_name),'folder_all')
end
